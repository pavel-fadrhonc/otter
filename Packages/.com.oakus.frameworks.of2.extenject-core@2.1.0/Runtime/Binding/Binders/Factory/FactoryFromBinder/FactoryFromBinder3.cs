...
namespace Zenject
{
    ...
    public static class FactoryFromBinder3Extensions
    {
        ...
        {
#if ENABLE_IL2CPP
            _Aot_workAround<TParam1, TParam2, TParam3, TContract>();
#endif
        ...
        {
#if ENABLE_IL2CPP
            _Aot_workAround_mono<TParam1, TParam2, TParam3, TContract>();
#endif
...
#if ENABLE_IL2CPP
        private static void _Aot_workAround<TParam1, TParam2, TParam3,TContract>()
            where TContract : IPoolable<TParam1, TParam2, TParam3,IMemoryPool>
        {
            var pool = new PoolableMemoryPool<TParam1, TParam2, TParam3,IMemoryPool, TContract>();
        }
        
        private static void _Aot_workAround_mono<TParam1, TParam2, TParam3,TContract>()
            where TContract : Component, IPoolable<TParam1, TParam2, TParam3,IMemoryPool>
        {
            var pool = new MonoPoolableMemoryPool<TParam1, TParam2, TParam3,IMemoryPool, TContract>();
        }
#endif
    }
}
